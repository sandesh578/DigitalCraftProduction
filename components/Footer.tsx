      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10'>
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16'>
          ...
          <div className='space-y-6 animate-fade-in-up'>
            <NavLink to='/' className='flex items-center space-x-3 group w-fit'>
              {logoUrl && logoLoaded ? (
                <img
                  src={logoUrl}
                  alt={agencyName}
                  className='h-10 w-10 object-contain drop-shadow-[0_0_10px_rgba(251,113,133,0.5)]'
              ...
              <div className='flex flex-col'>
                <span className='text-xl font-bold text-white leading-none'>
                  {mainTextFirst}
                  <span className='text-indigo-400'>{mainTextSecond}</span>
                </span>
                <span className='text-[0.6rem] font-bold text-slate-500 uppercase tracking-[0.15em] mt-0.5'>
                  {subText}
                </span>
              </div>
            </NavLink>
            <p className='text-sm leading-relaxed text-slate-400 max-w-xs'>
              {config.agency.tagline ||
                'From bold visuals to smart strategy, we craft campaigns that connect, convert, and captivate.'}
            </p>
            <div className='flex space-x-4 pt-2'>
              <a
                href='#'
                className='w-10 h-10 rounded-full bg-slate-900 flex items-center justify-center hover:bg-indigo-600 hover:text-white transition-all duration-300 shadow-sm border border-slate-800 hover:border-indigo-500'
              >
                <Facebook className='h-5 w-5' />
              </a>
              <a
                href='#'
                className='w-10 h-10 rounded-full bg-slate-900 flex items-center justify-center hover:bg-pink-600 hover:text-white transition-all duration-300 shadow-sm border border-slate-800 hover:border-pink-500'
              >
                <Instagram className='h-5 w-5' />
              </a>
              <a
                href='#'
                className='w-10 h-10 rounded-full bg-slate-900 flex items-center justify-center hover:bg-blue-600 hover:text-white transition-all duration-300 shadow-sm border border-slate-800 hover:border-blue-500'
              >
          ...
          <div className='animate-fade-in-up delay-100'>
            ...
            <ul className='space-y-3'>
              <li>
                <NavLink
                  to='/'
                  className='text-sm text-slate-400 hover:text-indigo-400 transition-colors flex items-center'
                >
                  <span className='w-1.5 h-1.5 rounded-full bg-indigo-500 mr-2 opacity-0 hover:opacity-100 transition-opacity'></span>
                  Home
                </NavLink>
              </li>
              <li>
          ...
          <div className='animate-fade-in-up delay-200'>
            ...
            <ul className='space-y-3'>
              <li className='text-sm text-slate-400 hover:text-indigo-400 transition-colors cursor-pointer'>
                Video Production
              </li>
              <li className='text-sm text-slate-400 hover:text-indigo-400 transition-colors cursor-pointer'>
                Web Development
            ...
            <ul className='space-y-5'>
              <li className='flex items-start space-x-3 group cursor-pointer'>
                ...
                <a
                  ...
                  className='text-sm text-slate-400 group-hover:text-white transition-colors leading-relaxed'
                >
                  {config.contact.address}
                </a>
              </li>
              ...
              <li className='flex items-center space-x-3 group'>
                ...
                <a
                  ...
                  className='text-sm text-slate-400 group-hover:text-white transition-colors break-all'
                >
        ...
        <div className='border-t border-slate-900 pt-8 flex flex-col md:flex-row justify-between items-center animate-fade-in-up delay-300'>
          <p className='text-sm text-slate-600 text-center md:text-left'>
            © {new Date().getFullYear()} {config.agency.name}. All rights
            reserved.
          </p>
