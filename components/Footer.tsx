        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="animate-fade-in-up delay-100">
            ...
            <ul className="space-y-3">
              ...
              <li><NavLink to="/dollar-services" className="text-sm text-slate-400 hover:text-indigo-400 transition-colors flex items-center"><span className="w-1.5 h-1.5 rounded-full bg-indigo-500 mr-2 opacity-0 hover:opacity-100 transition-opacity"></span>Dollar Services</NavLink></li>
            </ul>
          </div>
