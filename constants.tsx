...
export const SERVICES: Service[] = [
  ...
  {
    id: '13',
    title: 'Dollar Services & Ads Load',
    description: 'Pay in dollars for Meta, Google, TikTok ads, and manage international transfers easily from Nepal.',
    icon: DollarSign,
    color: 'bg-blue-500',
    features: [
      'Meta, Google & TikTok Ads Load',
      'Mastercard Load & PayPal Transfer',
      'Bank & Wise Transfers',
      'Lowest Rates Guaranteed'
    ],
    link: '/dollar-services'
  }
];
